...
class InputYY extends Input {
    ...
    /**
     * Evaluate if the group of laundry symbols is at an unknown position.
     * @return {boolean} True if it is; false otherwise.
     */
    isLaundryUnknown() {
        return this.laundryPosition === InputYY.LaundryPosition.UNKNOWN;
    }

    /**
     * Evaluate if the group of laundry symbols is at a valid position.
     * @return {boolean} True if it is; false otherwise.
     */
