...
// Constants
import { ALL_COLLECTIONS, ON_LIMITS_86_GARMENT_TYPE_ID as GARMENT_TYPE_ID, ON_LIMITS_86_LINE_ID as LINE_ID,
    ON_LIMITS_86_SEASON_ID as SEASON_ID, LINE } from "../constants/index.js";
const Season = Collection.Season;
const REGEX_ON_LIMITS_86 = /^[A-Z]{2}\d{5}$/;
const FRAMEWORK_ON_LIMITS_86 = "ISSEY MIYAKE ON LIMITS INC. (1986)";
 ...
 */
InputIM.prototype.isON_LIMITS_86 = function() {
    ...
    if (!REGEX_ON_LIMITS_86.test(productCode)) return false;
...
InputIM.prototype.extract_ON_LIMITS_86 = function() {
    ...
    let identification = new Identification({
        ...
        framework: FRAMEWORK_ON_LIMITS_86,
