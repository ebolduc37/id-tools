...
*/
InputCDG.prototype.extract = function() {
    ...
    identificationList.push(this.extract_Cdgcdg());
    identificationList.push(this.extract_Forever());
    identificationList.push(this.extract_ForeverException());
    identificationList.push(this.extract_Shirt());
    identificationList.push(this.extract_ShirtException());
    identificationList.push(this.extract_Monthly());
    identificationList.push(this.extract_Seasonal());
    identificationList.push(this.extract_SpecialCase());
