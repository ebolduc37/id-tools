...
import { LineCDG } from "../utils/index.js";

// Initializing useful parameters
const SEASONS = Collection.SEASONS;
const PRODUCTION_SCHEDULE_TYPES = LineCDG.PRODUCTION_SCHEDULE_TYPES;
...
const LINES = deepFreeze({
    ...
    GUCCI: new LineCDG("COMME des GARÇONS in collaboration with Gucci",
            new OperationPeriod(new Collection(2015, SEASONS.W), null,
                col => !col.isBetween(new Collection(2016, SEASONS.S), new Collection(2018, SEASONS.S)))),
