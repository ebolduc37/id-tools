...
const LINE_ID = deepFreeze({
     ...
     LINE.HH,
     LINE.JAN,
     LINE.JWCDGMAN.newBounds(new Collection(2006, Season.S), new Collection(2006, Season.S)),
     LINE.ALIVE,
     LINE.GDS,
     ...
     V: [LINE.JWCDG.newUpperBound(new Collection(2005, Season.W)),
     LINE.BEAT],
     ...
     Y: [LINE.JWCDGMAN.newUpperBound(new Collection(2005, Season.W))],
