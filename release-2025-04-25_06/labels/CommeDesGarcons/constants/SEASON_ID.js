...
const REG = (col, lastDigit) => col.isAfterOrIn(new Collection(2003, Season.W)) && col.year % 10 === lastDigit;
...
const SEASON_ID = Object.freeze({
  ...
  B: col => REG_W(col, 8),
  /** @param {Collection} col @return {boolean} */
  C: col => REG_S(col, 9) || col.isEqualTo(new Collection(2001, Season.W)),
  /** @param {Collection} col @return {boolean} */
  D: col => REG_W(col, 9) || col.isEqualTo(new Collection(2001, Season.W)),
  /** @param {Collection} col @return {boolean} */
  E: col => REG_S(col, 0) || col.isEqualTo(new Collection(2002, Season.S)),
  /** @param {Collection} col @return {boolean} */
  F: col => REG_W(col, 0) || col.isEqualTo(new Collection(2002, Season.S)),
  /** @param {Collection} col @return {boolean} */
  G: col => REG_S(col, 1) || col.isEqualTo(new Collection(2002, Season.W)),
  /** @param {Collection} col @return {boolean} */
  H: col => REG_W(col, 1) || col.isEqualTo(new Collection(2002, Season.W)),
  /** @param {Collection} col @return {boolean} */
  I: col => REG_S(col, 2) || col.isEqualTo(new Collection(2003, Season.S)),
  /** @param {Collection} col @return {boolean} */
  J: col => REG_W(col, 2) || col.isEqualTo(new Collection(2003, Season.S)),
  /** @param {Collection} col @return {boolean} */
  K: col => REG_S(col, 3) || col.isEqualTo(new Collection(2003, Season.W)),
  /** @param {Collection} col @return {boolean} */
  L: col => REG_W(col, 3),
  /** @param {Collection} col @return {boolean} */
  M: col => REG_S(col, 4),
  ...
  T: col => REG_W(col, 7),
  /** @param {Collection} col @return {boolean} */
  U: col => col.hasNoSeason(),
  /** @param {Collection} col @return {boolean} */
  Z: col => col.hasNoSeason(),
});
