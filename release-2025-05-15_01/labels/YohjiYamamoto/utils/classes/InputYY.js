...
const LogoStyle = Object.freeze({
    ...
    YS: {
        ANY: {
            SANS_SERIF: "YS_ANY_SANS_SERIF",
            SERIF: "YS_ANY_SERIF",
        },
        SANS_SERIF: "YS_SANS_SERIF", // 1972 -> A/W '87
        SERIF: {
            YOHJI_YAMAMOTO_ABSENT: "YS_YOHJI_YAMAMOTO_ABSENT",
            YOHJI_YAMAMOTO_RIGHT: "YS_YOHJI_YAMAMOTO_RIGHT",
            YOHJI_YAMAMOTO_UNDER: "YS_YOHJI_YAMAMOTO_UNDER",
        }, // S/S '88 -> NOW
        BRUSH: "YS_BRUSH",
    }, // 4 squares, 1 rectangle
    YS_FOR_MEN: {
        SANS_SERIF: "YS_FOR_MEN_SANS_SERIF", // 1972 -> A/W '87
        SERIF: {
            YOHJI_YAMAMOTO_ABSENT: "YS_FOR_MEN_YOHJI_YAMAMOTO_ABSENT",
            YOHJI_YAMAMOTO_UNDER: "YS_FOR_MEN_YOHJI_YAMAMOTO_UNDER",
        }, // S/S '88 -> NOW
    }, // 3 rectangles
...
class InputYY extends Input {
    ...
    /**
     * Evaluate if the logo is YS_FOR_MEN_SANS_SERIF.
     * @return {boolean} True if it is; false otherwise.
     */
    isLogoYS_FOR_MEN_SANS_SERIF() {
        return this.isLogo(InputYY.LogoStyle.YS_FOR_MEN.SANS_SERIF);
    }

    /**
     * Evaluate if the logo is any Y's sans serif.
     * @return {boolean} True if it is; false otherwise.
     */
    isLogoYS_ANY_SANS_SERIF() {
        return this.isLogo(InputYY.LogoStyle.YS.ANY.SANS_SERIF)
            || this.isLogoYS_SANS_SERIF()
            || this.isLogoYS_FOR_MEN_SANS_SERIF();
    }

    /**
     * Evaluate if the logo is YS_YOHJI_YAMAMOTO_ABSENT.
     * @return {boolean} True if it is; false otherwise.
     */
    isLogoYS_YOHJI_YAMAMOTO_ABSENT() {
        return this.isLogo(InputYY.LogoStyle.YS.SERIF.YOHJI_YAMAMOTO_ABSENT);
    }

    /**
     * Evaluate if the logo is YS_YOHJI_YAMAMOTO_RIGHT.
     * @return {boolean} True if it is; false otherwise.
     */
    isLogoYS_YOHJI_YAMAMOTO_RIGHT() {
        return this.isLogo(InputYY.LogoStyle.YS.SERIF.YOHJI_YAMAMOTO_RIGHT);
    }

    /**
     * Evaluate if the logo is YS_YOHJI_YAMAMOTO_UNDER.
     * @return {boolean} True if it is; false otherwise.
     */
    isLogoYS_YOHJI_YAMAMOTO_UNDER() {
        return this.isLogo(InputYY.LogoStyle.YS.SERIF.YOHJI_YAMAMOTO_UNDER);
    }

    /**
     * Evaluate if the logo is YS_FOR_MEN_YOHJI_YAMAMOTO_ABSENT.
     * @return {boolean} True if it is; false otherwise.
     */
    isLogoYS_FOR_MEN_YOHJI_YAMAMOTO_ABSENT() {
        return this.isLogo(InputYY.LogoStyle.YS_FOR_MEN.SERIF.YOHJI_YAMAMOTO_ABSENT);
    }

    /**
     * Evaluate if the logo is YS_FOR_MEN_YOHJI_YAMAMOTO_UNDER.
     * @return {boolean} True if it is; false otherwise.
     */
    isLogoYS_FOR_MEN_YOHJI_YAMAMOTO_UNDER() {
        return this.isLogo(InputYY.LogoStyle.YS_FOR_MEN.SERIF.YOHJI_YAMAMOTO_UNDER);
    }
     ...
     */
    isLogoYS_ANY_SERIF() {
        return this.isLogo(InputYY.LogoStyle.YS.ANY.SERIF)
            || this.isLogoYS_YOHJI_YAMAMOTO_ABSENT()
            || this.isLogoYS_YOHJI_YAMAMOTO_RIGHT()
            || this.isLogoYS_YOHJI_YAMAMOTO_UNDER()
            || this.isLogoYS_FOR_MEN_YOHJI_YAMAMOTO_ABSENT()
            || this.isLogoYS_FOR_MEN_YOHJI_YAMAMOTO_UNDER();
    }
     ...
     */
    isLogoYS() {
        return this.isLogoYS_ANY_SANS_SERIF() || this.isLogoYS_ANY_SERIF() || this.isLogoYS_BRUSH();
    }
    ...
    confirmLogoStyle() {
        ...
        else if (this.isLogoYS_FOR_MEN_SANS_SERIF()) message = "Y's for men sans-serif logo";
        else if (this.isLogoYS_ANY_SANS_SERIF()) message = "any Y's sans-serif logo";
        else if (this.isLogoYS_YOHJI_YAMAMOTO_ABSENT()) message = "Y's serif logo";
        else if (this.isLogoYS_YOHJI_YAMAMOTO_RIGHT()) message = "Y's serif logo with YOHJI YAMAMOTO on the right";
        else if (this.isLogoYS_YOHJI_YAMAMOTO_UNDER()) message = "Y's serif logo with YOHJI YAMAMOTO underneath";
        else if (this.isLogoYS_FOR_MEN_YOHJI_YAMAMOTO_ABSENT()) message = "Y's for men serif logo";
        else if (this.isLogoYS_FOR_MEN_YOHJI_YAMAMOTO_UNDER()) message = "Y's for men serif logo with YOHJI YAMAMOTO underneath";
        else if (this.isLogoYS_ANY_SERIF()) message = "any Y's serif logo";
    ...
    confirmLanguage() {
        ...
        else if (this.isLanguageJP_FR_EN()) message = "FR/EN/日本語";
    ...
    /**
     * Evaluate if "do not tumble dry" in Japanese ends in "ください。".
     * @return {boolean} True if it is; false otherwise.
     */
    isDoNotTumbleDryHIRAGANA() {
        return this.doNotTumbleDry === InputYY.DoNotTumbleDry.HIRAGANA;
    }

    /**
     * Evaluate if "do not tumble dry" in Japanese ends in "下さい。".
     * @return {boolean} True if it is; false otherwise.
     */
    isDoNotTumbleDryKANJI() {
        return this.doNotTumbleDry === InputYY.DoNotTumbleDry.KANJI;
    }
    ...
    confirmDoNotTumbleDry() {
        let message = "invalid entry";
        if (this.isDoNotTumbleDryKANJI()) message = "contains タンブラー乾燥はお避け[下]さい。";
        else if (this.isDoNotTumbleDryHIRAGANA()) message = "contains タンブラー乾燥はお避け[くだ]さい。";
        else if (this.isDoNotTumbleDryShort()) message = "contains タンブラー禁止";
        else if (this.isDoNotTumbleDryBLANK()) message = "contains no line of the form タンブラー[...]";
        else if (this.isDoNotTumbleDryUnspecified()) message = "unspecified";
        return "> Laundry instructions (JP): " + message;
    }
