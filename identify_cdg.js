...
const lineID_dict = {
    ...
    'I': [[name_dict['ind'],        'L',    [['S', 1984], ['W', 1987]]],
          ...
          [name_dict['jwman'],      'L',    [['S', 2006], ['W', 2006]]],
...
function identifyToString(identification) {
	...
	if (identification.length === 0) {
        return "Your item is unknown to us. Please let us know about it if you are sure that you have entered the right product code and year."
    }
    ...
    if (collections[0] === "fake") {
        collections.shift();
        result += "Your item might be a reproduction! "
    }

    // turning the identification information into a string
	result += "With product code " + code;
    switch(year) {
