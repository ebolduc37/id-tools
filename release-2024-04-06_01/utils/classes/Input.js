...
class Input {
    ...
    /**
     * Evaluate if the product code print is unclear.
     * @return {boolean} True if it is; false otherwise.
     */
    isProductCodeUnclear() {
        return this.productCode === Input.NoProductCode.UNCLEAR;
    }
    ...
    isProductCodeEqualTo(productCode) {
        ...
        if (this.isProductCodeUnclear() || input.isProductCodeUnclear()) return true;
    ...
    confirmProductCode() {
        ...
        else if (this.isProductCodeUnclear()) message = "unclear";
