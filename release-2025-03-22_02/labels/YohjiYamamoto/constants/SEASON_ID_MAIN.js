...
const UNKNOWN_1984_1987 = new OperationPeriod(new Collection(1984, Season.W), new Collection(1987, Season.W));
...
const SEASON_ID_MAIN = Object.freeze({
	...
	/** @param {Collection} col @return {boolean} */
	C: col => 	col.isEqualTo(new Collection(1986, Season.W)) ||
				col.isEqualTo(new Collection(1999, Season.S)) ||
	...
	/** @param {Collection} col @return {boolean} */
	O: col =>	(UNKNOWN_1984_1987.includes(col) && col.isW()) ||
				col.isEqualTo(new Collection(1993, Season.S)) ||
	...
	/** @param {Collection} col @return {boolean} */
	P: col =>	(UNKNOWN_1984_1987.includes(col) && col.isS()) ||
				col.isEqualTo(new Collection(1993, Season.W)) ||
	...
	/** @param {Collection} col @return {boolean} */
	S: col =>	(UNKNOWN_1984_1987.includes(col) && col.isS()) ||
				col.isEqualTo(new Collection(1992, Season.W)) ||
				col.isEqualTo(new Collection(2024, Season.S)),

	/** @param {Collection} col @return {boolean} */
	T: col =>	(UNKNOWN_1984_1987.includes(col) && col.isW()) ||
				col.isEqualTo(new Collection(1994, Season.S)) ||
