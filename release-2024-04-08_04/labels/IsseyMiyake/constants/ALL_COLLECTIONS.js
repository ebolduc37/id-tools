 ...
 *
 * Initialization of the set of all possible ISSEY MIYAKE
 * collection and production years up to the latest.
 *
...
/**
 * Array of all possible ISSEY MIYAKE collections and productions years.
 * @constant
 * @readonly
 * @type {Collection[]}
 * @default
