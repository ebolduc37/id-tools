...
const LOGO_YY = {
    ...
    "YY_2": new OperationPeriod(new Collection(1983, Season.W), new Collection(1991, Season.W)),
    "YY_3": new OperationPeriod(new Collection(1991, Season.W)),
    "YS_B": new OperationPeriod(null, null, col => col.isEqualTo(new Collection(1995, Season.S)))
};
const LOGO_YYPH = {
    "YY_1": new OperationPeriod(new Collection(1981, Season.W), new Collection(1985, Season.S)),
    "YY_2": new OperationPeriod(new Collection(1983, Season.W), new Collection(1991, Season.W)),
...
const LINE = deepFreeze({
    ...
    RYY: new LineYY("REGULATION Yohji Yamamoto",
            ...
            LOGO_MAIN, {
                MAIN: new OperationPeriod(null, new Collection(2018, Season.W),
                    col => !col.isBetween(new Collection(2014, Season.W), new Collection(2016, Season.S))),
                PRE: new OperationPeriod(new Collection(2014, Season.P))
            }),
    ...
    JEANS: new LineYY("Yohji JEANS",
            new OperationPeriod(new Collection(2012, Season.W), new Collection(2014, Season.W),
                col => col.isEqualTo(new Collection(2012, Season.W)) || col.isEqualTo(new Collection(2014, Season.W))),
    ...
    YFMRL: new LineYY("Y's for men [Red Label]",
            ...
            {
                "YS_2": new OperationPeriod(null, new Collection(2003, Season.S)),
    ...
    YFMS: new LineYY("Y's for men SHIRTS",
            new OperationPeriod(new Collection(1998, Season.S), new Collection(2001, Season.W)),
            LOGO_YS, PRODCYCLE_MAIN_AUX),
            // NEED TO VERIFY! MISSING INFO!!!!
            // most likely: main until ss99, aux until aw00 EXCEPT ss00
    YASP: new LineYY("Y's ASPESI",
            ...
            LOGO_YS, {
                ...
                AUX: new OperationPeriod(null, null, col => col.isEqualTo(new Collection(2009, Season.S))),
            }),
    ...
    NOIR: new LineYY("YOHJI YAMAMOTO + NOIR",
            ...
            {
                "YY_3": new OperationPeriod(new Collection(2007, Season.S)),
                "NOIR_1": new OperationPeriod(null, new Collection(2007, Season.S)),
            }, PRODCYCLE_MAIN),
    ...
    YSEX: new LineYY("Y's Exclusive",
            ...
            {
                "YS_1": new OperationPeriod(null, new Collection(2016, Season.W)),
                "YS_2": new OperationPeriod(new Collection(2016, Season.W))
            }, PRODCYCLE_AUX),
