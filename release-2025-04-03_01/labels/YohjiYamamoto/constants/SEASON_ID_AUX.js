...
const UNKNOWN_1994_1996 = new OperationPeriod(new Collection(1994, Season.W), new Collection(1996, Season.W));
const UNKNOWN_2000_2002 = new OperationPeriod(new Collection(2000, Season.S), new Collection(2002, Season.S));
