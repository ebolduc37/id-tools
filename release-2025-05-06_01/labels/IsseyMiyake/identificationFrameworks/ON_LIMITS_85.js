...
// Constants
import { ALL_COLLECTIONS, ON_LIMITS_85_GARMENT_TYPE_ID as GARMENT_TYPE_ID, ON_LIMITS_85_LINE_ID as LINE_ID,
    ON_LIMITS_85_SEASON_ID as SEASON_ID, LINE } from "../constants/index.js";
const Season = Collection.Season;
const REGEX_ON_LIMITS_85 = /^[L][G|Y]\d[2|3]\d{3}$/;
const FRAMEWORK_ON_LIMITS_85 = "ISSEY MIYAKE ON LIMITS INC. (1985)";
 ...
 */
InputIM.prototype.isON_LIMITS_85 = function() {
    ...
    if (!this.isTypefaceSlabSerif() && !this.isTypefaceUnspecified()) return false;
    ...
    if (!REGEX_ON_LIMITS_85.test(productCode)) return false;
...
InputIM.prototype.extract_ON_LIMITS_85 = function() {
    ...
    let identification = new Identification({
        ...
        framework: FRAMEWORK_ON_LIMITS_85,
