...
const UNKNOWN_2008W_2012S = new OperationPeriod(new Collection(2008, Season.W), new Collection(2012, Season.S));
const UNKNOWN_2011S_2012S = new OperationPeriod(new Collection(2011, Season.S), new Collection(2012, Season.S));
...
const SEASON_ID_AUX = Object.freeze({
	...
	/** @param {Collection} col @return {boolean} */
	C: col => 	col.isEqualTo(new Collection(1992, Season.W)) ||
				col.isEqualTo(new Collection(2004, Season.W)),

	/** @param {Collection} col @return {boolean} */
	D: col => 	col.isEqualTo(new Collection(1994, Season.S)) ||
				col.isEqualTo(new Collection(2001, Season.S)) ||
	...
	/** @param {Collection} col @return {boolean} */
	F: col => 	col.isEqualTo(new Collection(2002, Season.S)),
	...
	/** @param {Collection} col @return {boolean} */
	H: col => 	col.isEqualTo(new Collection(1994, Season.W)) || //(UNKNOWN_1994_1996.includes(col) && col.isW()) ||
	...
	/** @param {Collection} col @return {boolean} */
	L: col => 	col.isEqualTo(new Collection(1993, Season.W)) ||
	...
	M: col => 	col.isEqualTo(new Collection(1988, Season.S)) ||
				col.isEqualTo(new Collection(1995, Season.W)) || //(UNKNOWN_1994_1996.includes(col) && col.isW()) ||
	...
	/** @param {Collection} col @return {boolean} */
	R: col =>	col.isEqualTo(new Collection(1993, Season.S)) ||
				col.isEqualTo(new Collection(1999, Season.W)),
	...
	/** @param {Collection} col @return {boolean} */
	V: col =>	col.isEqualTo(new Collection(2014, Season.W)) ||
	...
	X: col =>	col.isEqualTo(new Collection(1991, Season.W)) ||
				col.isEqualTo(new Collection(1996, Season.W)) || //(UNKNOWN_1994_1996.includes(col) && col.isW()) ||
