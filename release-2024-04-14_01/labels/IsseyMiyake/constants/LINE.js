...
const LINE = deepFreeze({
	...
	IM: new Line("ISSEY MIYAKE",
			new OperationPeriod(new Collection(1972, Season.S), new Collection(1999, Season.W)),
			LOGO_LIST_IM),
	IMNT: new Line("ISSEY MIYAKE [by Naoki Takizawa]",
			...
			LOGO_LIST_IM),
	IMDF: new Line("ISSEY MIYAKE [by Dai Fujiwara]",
			new OperationPeriod(new Collection(2007, Season.W), new Collection(2011, Season.W)),
			LOGO_LIST_IM),
	IMYM: new Line("ISSEY MIYAKE [by Yoshiyuki Miyamae]",
			new OperationPeriod(new Collection(2012, Season.S), new Collection(2019, Season.W)),
			LOGO_LIST_IM),
	IMSK: new Line("ISSEY MIYAKE [by Satoshi Kondo]",
			new OperationPeriod(new Collection(2020, Season.S)),
			LOGO_LIST_IM),
	...
	WC: new Line("WINDCOAT", // always alphabetical
			new OperationPeriod(new Collection(1995, Season.S), new Collection(2003, Season.W))),
	...
	ME: new Line("ISSEY MIYAKE MEN",
		new OperationPeriod(new Collection(1976), new Collection(2020, Season.W),
			col => !col.isBetween(new Collection(1994, Season.S), new Collection(2020, Season.S))),
			LOGO_LIST_ME),
	MENT: new Line("ISSEY MIYAKE MEN [by Naoki Takizawa]",
			...
			LOGO_LIST_ME),
	MEDF: new Line("ISSEY MIYAKE MEN [by Dai Fujiwara]",
			new OperationPeriod(new Collection(2007, Season.W), new Collection(2011, Season.W)),
			LOGO_LIST_ME),
	MEYT: new Line("ISSEY MIYAKE MEN [by Yusuke Takahashi]",
			new OperationPeriod(new Collection(2012, Season.S), new Collection(2020, Season.S)),
			LOGO_LIST_ME),
