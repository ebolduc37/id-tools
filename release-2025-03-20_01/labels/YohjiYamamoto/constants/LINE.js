...
const LOGO_YS = {
    "YS_1": new OperationPeriod(new Collection(1972, Season.S), new Collection(1987, Season.W)),
    "YS_2": new OperationPeriod(new Collection(1988, Season.S))
};
const LOGO_YFM = {
    "YS_1": new OperationPeriod(new Collection(1979, Season.S), null,
            col => !col.isBetween(new Collection(1988, Season.R), new Collection(2023, Season.S))),
    "YS_2": new OperationPeriod(new Collection(1988, Season.S), new Collection(2023, Season.S))
};
const LOGO_YFMRL = {
...
const LOGO_YSEX = {
    "YS_1": new OperationPeriod(new Collection(2013, Season.R), new Collection(2016, Season.P)),
    "YS_2": new OperationPeriod(new Collection(2016, Season.P), new Collection(2018, Season.P))
};
const LOGO_YS_1 = {
...
const LINE = deepFreeze({
    ...
    JEANS: new LineYY("Yohji JEANS",
            new OperationPeriod(new Collection(2012, Season.W), new Collection(2014, Season.W),
                col => !col.isBetween(new Collection(2013, Season.S), new Collection(2014, Season.S))),
            LOGO_MAIN), // found GH-B02-007, GH-P01-001, GH-P01-002
    ...
    YFM: new LineYY("Y's for men", // ALSO FOUND WITH U (ONCE) -> UI from 90s
            new OperationPeriod(new Collection(1979, Season.S), null,
                col => !col.isBetween(new Collection(2010, Season.R), new Collection(2023, Season.P))),
            LOGO_YFM),
