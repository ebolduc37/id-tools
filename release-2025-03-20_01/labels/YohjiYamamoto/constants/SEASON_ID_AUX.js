...
const SEASON_ID_AUX = Object.freeze({
	...
	B: 	col => 	col.isEqualTo(new Collection(1990, Season.S)) ||
				...
				col.isEqualTo(new Collection(2020, Season.P)) ||
	...
	C: col => 	col.isEqualTo(new Collection(1999, Season.S)) ||
				...
				col.isEqualTo(new Collection(2020, Season.W, null, null, true)) ||
	...
	E: col => 	col.isEqualTo(new Collection(1988, Season.W)) ||
				...
				col.isEqualTo(new Collection(2018, Season.R)) ||
				col.isEqualTo(new Collection(2022, Season.W)),

	/** @param {Collection} col @return {boolean} */
	F: col => 	col.isEqualTo(new Collection(1989, Season.W)) ||
				col.isEqualTo(new Collection(1996, Season.S)) ||
	...
	H: col => 	col.isEqualTo(new Collection(2019, Season.S)) ||
				col.isEqualTo(new Collection(2023, Season.S, null, null, true)),

	/** @param {Collection} col @return {boolean} */
	I: col => 	col.isEqualTo(new Collection(1997, Season.W)) ||
				col.isEqualTo(new Collection(2018, Season.P)) ||
	...
	K: col => 	col.isEqualTo(new Collection(2017, Season.W)) ||
				col.isEqualTo(new Collection(2021, Season.W, null, null, true)),

	/** @param {Collection} col @return {boolean} */
	L: col => 	col.isEqualTo(new Collection(1987, Season.W)) ||
				col.isEqualTo(new Collection(2016, Season.P)) ||
				col.isEqualTo(new Collection(2021, Season.S, null, null, true)),

	/** @param {Collection} col @return {boolean} */
	M: col => 	col.isEqualTo(new Collection(2002, Season.W)) ||
				col.isEqualTo(new Collection(2008, Season.S)) ||
				col.isEqualTo(new Collection(2021, Season.P)),
	...
	N: col => 	col.isEqualTo(new Collection(1999, Season.W)) ||
				...
				col.isEqualTo(new Collection(2024, Season.S, null, null, true)),
	...
	P: col =>	col.isEqualTo(new Collection(1993, Season.W)) ||
				...
				col.isEqualTo(new Collection(2016, Season.R)) ||
	...
	Q: col =>	col.isEqualTo(new Collection(1991, Season.S)) ||
				...
				col.isEqualTo(new Collection(2017, Season.P)) ||
	...
	R: col =>	col.isEqualTo(new Collection(1987, Season.S)) ||
				...
				col.isEqualTo(new Collection(2024, Season.W, null, null, true)),
	...
	T: col =>	col.isEqualTo(new Collection(1994, Season.S)) ||
				...
				col.isEqualTo(new Collection(2021, Season.R)) ||
	...
	W: col =>	col.isEqualTo(new Collection(2018, Season.S)) ||
				col.isEqualTo(new Collection(2022, Season.S, null, null, true)),
	...
	X: col =>	col.isEqualTo(new Collection(2001, Season.S)) ||
				...
				col.isEqualTo(new Collection(2017, Season.R)) ||
	...
	Y: col =>	col.isEqualTo(new Collection(1998, Season.W)) ||
				...
				col.isEqualTo(new Collection(2024, Season.R)),
	...
	Z: col =>	col.isEqualTo(new Collection(1992, Season.S)) ||
				...
				col.isEqualTo(new Collection(2019, Season.R)) ||
