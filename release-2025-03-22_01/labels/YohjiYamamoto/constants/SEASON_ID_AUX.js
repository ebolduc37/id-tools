...
const SEASON_ID_AUX = Object.freeze({
	...
	/** @param {Collection} col @return {boolean} */
	D: col => 	(UNKNOWN_1992_1996.includes(col) && col.isS()) ||
	...
	/** @param {Collection} col @return {boolean} */
	L: col => 	(UNKNOWN_1992_1996.includes(col) && col.isW()) ||
				(UNKNOWN_1999_2002.includes(col) && col.isW()) ||
	...
	/** @param {Collection} col @return {boolean} */
	P: col =>	(UNKNOWN_1999_2002.includes(col) && col.isS()) ||
	...
	/** @param {Collection} col @return {boolean} */
	T: col =>	col.isEqualTo(new Collection(2021, Season.S)) ||
