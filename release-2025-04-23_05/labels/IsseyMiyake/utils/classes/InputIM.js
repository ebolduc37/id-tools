...
class InputIM extends Input {
    ...
    constructor({ productCode, logoStyle, manufacturer, sizing, typeface }) {
        ...
        this.manufacturer = (manufacturer == null || manufacturer === 'undefined')? InputIM.Manufacturer.UNSPECIFIED : manufacturer;
        /** @type {InputIM.Sizing} */
        this.sizing = (sizing == null || sizing === 'undefined')? InputIM.Sizing.UNSPECIFIED : sizing;
        /** @type {InputIM.Typeface} */
        this.typeface = (typeface == null || typeface === 'undefined')? InputIM.Typeface.UNSPECIFIED : typeface;
    }
