...
// Constants
import { ALL_COLLECTIONS, COUNTERFEITS, GARMENT_TYPE_ID, LINE_ID, LINE, SEASON_ID } from "../constants/index.js";
...
InputYY.prototype.extract_Regular = function() {
    ...
    if (this.getProductCodeStandardized() in COUNTERFEITS) {
        ...
        if (lineList.length === 0) {
            lineList.push(COUNTERFEITS[this.getProductCodeStandardized()].lineList[0].copy());
            lineList[0].name = "Counterfeit of " + lineList[0].name;
        }
    }
