 ...
 *
 * Initialization of the ISSEY MIYAKE INT'L. INC. season IDs and their corresponding
...
/**
 * Enum for the ISSEY MIYAKE INT'L. INC. season IDs and conditional functions to filter accordingly.
 * @constant
 * @readonly
 * @enum {lambda}
 */
