...
const MM_LABEL_NOTATION_MM6 = MM.LabelNotation['MM6'];
...
const inputMM = [
    ...
    { label: MM.Label, labelNotation: MM_LABEL_NOTATION_1, productCode: "00905/011" }, // ss01
    { label: MM.Label, labelNotation: MM_LABEL_NOTATION_1, productCode: "00582/0012" }, // aw01
    { label: MM.Label, labelNotation: MM_LABEL_NOTATION_1, productCode: "01592/0042" }, // aw04
    { label: MM.Label, labelNotation: MM_LABEL_NOTATION_1, productCode: "02711/0062" }, // aw06
    { label: MM.Label, labelNotation: MM_LABEL_NOTATION_1, productCode: "01753/03/01/0071" }, // ss07
    { label: MM.Label, labelNotation: MM_LABEL_NOTATION_1, productCode: "00688/02/01/0101" }, // ss10? saw ss01
    { label: MM.Label, labelNotation: MM_LABEL_NOTATION_1, productCode: "10093/01/01/0102" }, // aw10? saw ss01
    { label: MM.Label, labelNotation: MM_LABEL_NOTATION_1, productCode: "02PR/2010/2253 - 2010 02" }, // aw10
    { label: MM.Label, labelNotation: MM_LABEL_NOTATION_1, productCode: "02PR/2010/2253 - 2010 02" }, // aw10
    { label: MM.Label, labelNotation: MM_LABEL_NOTATION_1, productCode: "02CC/2012/60001 - 2012 02" }, // aw12
    { label: MM.Label, labelNotation: MM_LABEL_NOTATION_1, productCode: "02PR/2013/54 - 2013 02" }, // aw13
    { label: MM.Label, labelNotation: MM_LABEL_NOTATION_1, productCode: "01PR/2021/3473/1 - 2021 01" }, // ss21
    { label: MM.Label, labelNotation: MM_LABEL_NOTATION_1, productCode: "01PR/2021/3473/1 - 2021 01" }, // ss21
    { label: MM.Label, labelNotation: MM_LABEL_NOTATION_BLANK, productCode: "01PR/2021/3473/1 - 2021 01" }, // ss21
    ...
    { label: MM.Label, labelNotation: MM_LABEL_NOTATION_MM6, productCode: MM_CODE_UNSPECIFIED },
