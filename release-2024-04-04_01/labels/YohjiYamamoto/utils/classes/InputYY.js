 ...
 * @enum {string}
 */
const LaundryLocation = Object.freeze({
    BELOW: "BELOW",
    ABOVE: "ABOVE",
    UNKNOWN: "UNKNOWN"
});
...
class InputYY extends Input {
    ...
    static LaundryLocation = LaundryLocation;
     ...
     * @param {InputYY.LaundryLocation} laundryLocation - Object to extract the laundry symbols location from.
     */
    constructor({ productCode, logoStyle, sizingSystem, fontType, laundryLocation }) {
    ...
    copy() {
        return new InputYY({ productCode: this.productCode, logoStyle: this.logoStyle,
            ...
            laundryLocation: this.laundryLocation });
    }
     ...
     */
    isLogoElse() {
        return this.isLogo(InputYY.LogoStyle.ELSE);
    }
     ...
     */
    isLogoEntered() {
        return this.logoStyle !== null && !this.isLogo(InputYY.LogoStyle.UNKNOWN);
    }
     ...
     */
    isLogoStyleValid() {
        return !this.isLogoEntered() || this.isLogo(InputYY.LogoStyle);
    }
     ...
     */
    isSizingUnknown() {
        return this.sizingSystem === InputYY.SizingSystem.UNKNOWN;
    }
     ...
     */
    isFontUnknown() {
        return this.fontType === InputYY.FontType.UNKNOWN;
    }
     ...
     */
    isLaundryBelow() {
        return this.laundryLocation === InputYY.LaundryLocation.BELOW;
    }
     ...
     */
    isLaundryAbove() {
        return this.laundryLocation === InputYY.LaundryLocation.ABOVE;
    }
     ...
     */
    isLaundryUnknown() {
        return this.laundryLocation === InputYY.LaundryLocation.UNKNOWN;
    }
    ...
    isValid() {
        ...
        if (!this.isLaundryLocationValid()) return false;
        return true;
    }
}
