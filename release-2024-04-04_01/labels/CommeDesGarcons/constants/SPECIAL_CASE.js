 ...
 * @constant
 * @readonly
 * @enum {{yearPrint: (string|InputCDG.NoYearPrintType), identification: Identification}}
 */
const SPECIAL_CASE = deepFreeze({

	"08BBT01": {
		yearPrint: InputCDG.NoYearPrintType.BLANK,
		identification: new Identification({
			input: new InputCDG({ productCode: "08BBT01", yearPrint: "InputCDG.NoYearPrintType.BLANK" }),
	...
	"08BBT02": {
		yearPrint: InputCDG.NoYearPrintType.BLANK,
		identification: new Identification({
			input: new InputCDG({ productCode: "08BBT02", yearPrint: "InputCDG.NoYearPrintType.BLANK" }),
			label: Identification.Label.CDG,
	...
	"SD19T60C": {
		yearPrint: InputCDG.NoYearPrintType.BLANK,
		identification: new Identification({
			input: new InputCDG({ productCode: "SD19T60C", yearPrint: "InputCDG.NoYearPrintType.BLANK" }),
			label: Identification.Label.CDG,
	...
	"5FT08A": {
		yearPrint: InputCDG.NoYearPrintType.BLANK,
		identification: new Identification({
			input: new InputCDG({ productCode: "5FT08A", yearPrint: "InputCDG.NoYearPrintType.BLANK" }),
			label: Identification.Label.CDG,
			codeStylized: "5FT08A",
			garmentType: GARMENT_TYPE_ID.T,
	...
	"5FT08B": {
		yearPrint: InputCDG.NoYearPrintType.BLANK,
		identification: new Identification({
			input: new InputCDG({ productCode: "5FT08B", yearPrint: "InputCDG.NoYearPrintType.BLANK" }),
			label: Identification.Label.CDG,
			codeStylized: "5FT08B",
			garmentType: GARMENT_TYPE_ID.T,
			lineList: [LINE.CCSS.forIdentification([new Collection(2011, Season.S)])],
	...
	"CDGS2ST": {
		yearPrint: InputCDG.NoYearPrintType.BLANK,
		identification: new Identification({
			input: new InputCDG({ productCode: "CDGS2ST", yearPrint: "InputCDG.NoYearPrintType.BLANK" }),
			label: Identification.Label.CDG,
	...
	"CDGS2PL": {
		yearPrint: InputCDG.NoYearPrintType.BLANK,
		identification: new Identification({
			input: new InputCDG({ productCode: "CDGS2PL", yearPrint: "InputCDG.NoYearPrintType.BLANK" }),
			label: Identification.Label.CDG,
	...
	"PDB007": {
		yearPrint: InputCDG.NoYearPrintType.BLANK,
		identification: new Identification({
			input: new InputCDG({ productCode: "PDB007", yearPrint: "InputCDG.NoYearPrintType.BLANK" }),
			label: Identification.Label.CDG,
	...
	"PFP043": {
		yearPrint: InputCDG.NoYearPrintType.BLANK,
		identification: new Identification({
			input: new InputCDG({ productCode: "PFP043", yearPrint: "InputCDG.NoYearPrintType.BLANK" }),
			label: Identification.Label.CDG,
	...
	"CDGCH01": {
		yearPrint: InputCDG.NoYearPrintType.BLANK,
		identification: new Identification({
			input: new InputCDG({ productCode: "CDGCH01", yearPrint: "InputCDG.NoYearPrintType.BLANK" }),
			label: Identification.Label.CDG,
	...
	"CDGCH02": {
		yearPrint: InputCDG.NoYearPrintType.BLANK,
		identification: new Identification({
			input: new InputCDG({ productCode: "CDGCH02", yearPrint: "InputCDG.NoYearPrintType.BLANK" }),
			label: Identification.Label.CDG,
	...
	"CDGCH03": {
		yearPrint: InputCDG.NoYearPrintType.BLANK,
		identification: new Identification({
			input: new InputCDG({ productCode: "CDGCH03", yearPrint: "InputCDG.NoYearPrintType.BLANK" }),
			label: Identification.Label.CDG,
	...
	"CDGCH04": {
		yearPrint: InputCDG.NoYearPrintType.BLANK,
		identification: new Identification({
			input: new InputCDG({ productCode: "CDGCH04", yearPrint: "InputCDG.NoYearPrintType.BLANK" }),
			label: Identification.Label.CDG,
