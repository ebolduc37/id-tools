...
import { identify, idList, CDG, YY } from "./index.js";

const CDG_YEAR_BLANK = CDG.NoYearPrintType.BLANK;
const CDG_YEAR_INDEFINITE = CDG.NoYearPrintType.INDEFINITE;
const CDG_YEAR_UNKNOWN = CDG.NoYearPrintType.UNKNOWN;
...
const inputCDG = [
    ...
    { label: CDG.Label, productCode: "PB-02123M", yearPrint: CDG_YEAR_INDEFINITE },
    { label: CDG.Label, productCode: "HB-02123M", yearPrint: CDG_YEAR_INDEFINITE },
    { label: CDG.Label, productCode: "PB-05123M", yearPrint: CDG_YEAR_INDEFINITE },
    { label: CDG.Label, productCode: "HB-05123M", yearPrint: CDG_YEAR_INDEFINITE },
    { label: CDG.Label, productCode: "PB-08123M", yearPrint: CDG_YEAR_INDEFINITE },
    { label: CDG.Label, productCode: "HB-08123M", yearPrint: CDG_YEAR_INDEFINITE },
    { label: CDG.Label, productCode: "PB-11123M", yearPrint: CDG_YEAR_INDEFINITE },
    { label: CDG.Label, productCode: "HB-11123M", yearPrint: CDG_YEAR_INDEFINITE },
...
const YY_CODE_BLANK = YY.NoProductCodeType.BLANK;
const YY_CODE_INDEFINITE = YY.NoProductCodeType.INDEFINITE;
const YY_CODE_UNKNOWN = YY.NoProductCodeType.UNKNOWN;
...
const YY_LAUNDRY_ABOVE = YY.LaundryLocation.ABOVE;
const YY_LAUNDRY_BELOW = YY.LaundryLocation.BELOW;
const YY_LAUNDRY_UNKNOWN = YY.LaundryLocation.UNKNOWN;

const inputYY = [
    { label: YY.Label, productCode: "HZ-B10-104", logoStyle: YY_LOGO_YY_3,
                    sizingSystem: YY_SIZING_ALPHABETICAL, fontType: YY_FONT_SERIF,
                    laundryLocation: YY_LAUNDRY_BELOW },
    ...
    { label: YY.Label, productCode: "HN-Y01-003", logoStyle: YY_LOGO_YY_3,
                    ...
                    laundryLocation: YY_LAUNDRY_ABOVE },
    ...
    { label: YY.Label, productCode: YY_CODE_UNKNOWN, logoStyle: YY_LOGO_YY_3,
                    sizingSystem: YY_SIZING_NUMERICAL, fontType: YY_FONT_SANS_SERIF,
                    laundryLocation: YY_LAUNDRY_UNKNOWN },
    { label: YY.Label, productCode: YY_CODE_UNKNOWN, logoStyle: YY_LOGO_YY_3,
