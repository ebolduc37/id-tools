...
// Constants
import { ALL_COLLECTIONS, OL83_GARMENT_TYPE_ID as GARMENT_TYPE_ID, OL83_LINE_ID as LINE_ID,
    OL83_SEASON_ID as SEASON_ID, LINE } from "../constants/index.js";
const Season = Collection.Season;
const REGEX_OL83 = /^[A-Z]{2}\d{5}$/;
const FRAMEWORK_OL83 = "ISSEY MIYAKE ON LIMITS INC. (1983-1985)";
 ...
 */
InputIM.prototype.isOL83 = function() {
    ...
    if (!REGEX_OL83.test(productCode)) return false;
