...
// Constants
import { ALL_COLLECTIONS, OL87_GARMENT_TYPE_ID as GARMENT_TYPE_ID, OL87_LINE_ID as LINE_ID,
    OL87_SEASON_ID as SEASON_ID, LINE } from "../constants/index.js";
const Season = Collection.Season;
const REGEX_OL87 = /^[K|X][A-Z]\d{5}([A-Z]{2})?$/;
const FRAMEWORK_OL87 = "ISSEY MIYAKE ON LIMITS INC. (1987-1988)";
 ...
 */
InputIM.prototype.isOL87 = function() {
    ...
    if (!REGEX_OL87.test(productCode)) return false;
