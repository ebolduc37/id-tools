...
export const name_dict = {
  ...
  // B
  ppDSM:
    "COMME des GARÇONS parfums PARFUMS (shop exclusive DOVER STREET MARKET launch)",
  // D
  ...
  ise2man:
    "COMME des GARÇONS HOMME PLUS (CELEBRATION ISETAN MEN'S 1YEAR + COMME des GARCONS 2 MAN)",
  ...
  people:
    "COMME des GARÇONS (People of the Year by COMME des GARÇONS and SWITCH)",
  // P
