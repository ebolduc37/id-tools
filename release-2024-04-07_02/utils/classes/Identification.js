...
class Identification {
    ...
    constructor({ input, label, framework, exception = false, counterfeit = false,
                    stylizedCode, garmentType = "a piece", fabricType, garmentSize,
                    manufacturer, lineList }) {
        /** @type {Input} */
        this.input = null;
    ...
    copy() {
        return new Identification({
            ...
            counterfeit: this.counterfeit, stylizedCode: this.stylizedCode, garmentType: this.garmentType,
            fabricType: this.fabricType, garmentSize: this.garmentSize,
            manufacturer: this.manufacturer, lineList: this.lineList
        });
    }
    ...
    result() {
        ...
        // Size
        if (this.fabricType != null) str += `in a ${this.fabricType} type of fabric `;
