...
const LogoStyle = Object.freeze({
    YOHJI_YAMAMOTO: {
        ...
        SHARP: "YOHJI_YAMAMOTO_SHARP" // A/W '91 -> NOW
    },
    YS: {
...
class InputYY extends Input {
    ...
    constructor({ productCode, logoStyle, sizingSystem, typeface, language,
        ...
        this.sizingSystem = (sizingSystem == null)? InputYY.SizingSystem.UNSPECIFIED : sizingSystem;
        /** @type {InputYY.Typeface} */
        this.typeface = (typeface == null)? InputYY.Typeface.UNSPECIFIED : typeface;
        /** @type {InputYY.Language} */
        this.language = (language == null)? InputYY.Language.UNSPECIFIED : language;
        /** @type {InputYY.LaundryPosition} */
        this.laundryPosition = (laundryPosition == null)? InputYY.LaundryPosition.UNSPECIFIED : laundryPosition;
        /** @type {InputYY.Manufacturer} */
        this.manufacturer = (manufacturer == null)? InputYY.Manufacturer.UNSPECIFIED : manufacturer;
    }
    ...
    /**
     * Evaluate if the logo is YOHJI_YAMAMOTO_SHARP.
     * @return {boolean} True if it is; false otherwise.
     */
    isLogoYOHJI_YAMAMOTO_SHARP() {
        return this.isLogo(InputYY.LogoStyle.YOHJI_YAMAMOTO.SHARP);
    }
     ...
     */
    isLogoYY() {
        return this.isLogoYOHJI_YAMAMOTO_ROUND() || this.isLogoYOHJI_YAMAMOTO_ROUGH() || this.isLogoYOHJI_YAMAMOTO_SHARP();
    }
    ...
    confirmLogoStyle() {
        ...
        else if (this.isLogoYOHJI_YAMAMOTO_SHARP()) message = "Yohji Yamamoto sharp signature logo";
