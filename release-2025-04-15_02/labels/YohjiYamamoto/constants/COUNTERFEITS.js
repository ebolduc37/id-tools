...
const COUNTERFEITS = deepFreeze({
    ...
    "KT11045": new Identification({
        input: new InputYY({ productCode: "K-T11-045", logoStyle: InputYY.LogoStyle.YOHJI_YAMAMOTO.SHARP,
            sizingSystem: InputYY.SizingSystem.NUMERICAL, fontType: InputYY.Typeface.MONOSPACED,
    ...
    "HFB06933": new Identification({
        input: new InputYY({ productCode: "HF-B06-933", logoStyle: InputYY.LogoStyle.YOHJI_YAMAMOTO.SHARP,
            sizingSystem: InputYY.SizingSystem.ALPHABETICAL, fontType: InputYY.Typeface.UNSPECIFIED,
            fabricContent: InputYY.Language.FR_EN_JP, laundryPosition: InputYY.LaundryPosition.BOTTOM,
            manufacturer: InputYY.Manufacturer.YOHJI_YAMAMOTO_INC }),
        exception: true,
        label: Identification.Label.YY,
    ...
    "HEB23288": new Identification({
        input: new InputYY({ productCode: "HE-B23-288", logoStyle: InputYY.LogoStyle.YOHJI_YAMAMOTO.SHARP,
            sizingSystem: InputYY.SizingSystem.NUMERICAL, fontType: InputYY.Typeface.MONOSPACED,
            fabricContent: InputYY.Language.FR_EN_JP, laundryPosition: InputYY.LaundryPosition.BOTTOM,
            manufacturer: InputYY.Manufacturer.YOHJI_YAMAMOTO_INC }),
        exception: true,
