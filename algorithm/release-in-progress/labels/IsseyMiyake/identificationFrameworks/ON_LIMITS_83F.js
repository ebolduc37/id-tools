...
const REGEX_ON_LIMITS_83F = /^[F][A-Z]\d{4}[4]$/;
const FRAMEWORK_ON_LIMITS_83F = "ISSEY MIYAKE ON LIMITS INC. (1983-1985) 'F'";
 ...
 */
InputIM.prototype.isON_LIMITS_83F = function() {
    ...
    if (!REGEX_ON_LIMITS_83F.test(productCode)) return false;
...
InputIM.prototype.extract_ON_LIMITS_83F = function() {
    ...
    let identification = new Identification({
        ...
        framework: FRAMEWORK_ON_LIMITS_83F,
