...
class InputMM extends Input {
    ...
    constructor({ labelNotation, productCode, manufacturer }) {
        ...
        this.labelNotation = (labelNotation == null)? LabelNotation.UNSPECIFIED : labelNotation;
        /** @type {InputMM.Manufacturer} */
        this.manufacturer = (manufacturer == null)? Manufacturer.UNSPECIFIED : manufacturer;
    }
