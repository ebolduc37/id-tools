...
class InputIM extends Input {
     ...
     */
    constructor({ productCode, logoStyle, manufacturer, sizingSystem, typeface }) {
        ...
        this.sizingSystem = (sizingSystem == null)? InputIM.SizingSystem.UNSPECIFIED : sizingSystem;
    ...
    confirmLogoStyle() {
        ...
        else if (this.isLogoROUND()) message = "rounded ISSEY MIYAKE and variants";
        else if (this.isLogoBRUSH()) message = "rounded ISSEY MIYAKE over brushstroke and variants";
        else if (this.isLogoIM_BLACK_ON_WHITE()) message = "black ISSEY MIYAKE over white background";
        else if (this.isLogoIM_WHITE_ON_BLACK()) message = "white ISSEY MIYAKE over black background";
        else if (this.isLogoME_BLACK_ON_WHITE()) message = "black ISSEY MIYAKE MEN over white background";
        else if (this.isLogoME_WHITE_ON_BLACK()) message = "white ISSEY MIYAKE MEN over black background";
