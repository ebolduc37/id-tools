...
const SEASON_ID_PRE = Object.freeze({
	...
	/** @param {Collection} col @return {boolean} */
	E: col => 	col.isEqualTo(new Collection(2015, Season.R)) ||
	...
	/** @param {Collection} col @return {boolean} */
	K: col => 	col.isEqualTo(new Collection(2013, Season.R)),

	/** @param {Collection} col @return {boolean} */
	L: col => 	col.isEqualTo(new Collection(2016, Season.P)),

	/** @param {Collection} col @return {boolean} */
	M: col => 	col.isEqualTo(new Collection(2014, Season.R)) ||
	...
	/** @param {Collection} col @return {boolean} */
	V: col =>	col.isEqualTo(new Collection(2014, Season.P)) ||
