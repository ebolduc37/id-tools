 ...
 */
InputCDG.prototype.extract_Shirt94W = function() {
    ...
    identification.stylizedCode = productCode.slice(0, 2) + "-" + productCode.slice(2);
    // Assigning the size
 ...
 * @return {Identification[]} Identification of the occurrence of a possible collection.
 */
InputCDG.prototype.extract_Shirt01S = function() {
 ...
 * @return {Identification[]} Identification of the occurrence of a possible collection.
 */
InputCDG.prototype.extract_Shirt01W = function() {
 ...
 */
InputCDG.prototype.extract_ShirtException = function() {
    if (this.isShirt94W()) return this.extract_Shirt94W();
    else if (this.isShirt01S()) return this.extract_Shirt01S();
    else if (this.isShirt01W()) return this.extract_Shirt01W();
    else return [];
};
