...
const LINE = deepFreeze({
    ...
    // J
    JWCDG: new LineCDG("JUNYA WATANABE COMME des GARÇONS",
        new OperationPeriod(new Collection(1992, Season.W), new Collection(2021, Season.W)),
        ProductionSchedule.EARLY),
    JW: new LineCDG("JUNYA WATANABE",
    ...
    // W
    JWCDGMAN: new LineCDG("JUNYA WATANABE COMME des GARÇONS MAN",
        new OperationPeriod(new Collection(2002, Season.S), new Collection(2021, Season.W)),
        ProductionSchedule.EARLY),
    EYECDG: new LineCDG("eYe JUNYA WATANABE COMME des GARÇONS MAN",
        new OperationPeriod(new Collection(2005, Season.W), new Collection(2021, Season.W))),
    JWMAN: new LineCDG("JUNYA WATANABE MAN",
        new OperationPeriod(new Collection(2022, Season.S)),
        ProductionSchedule.EARLY),
    EYE: new LineCDG("eYe JUNYA WATANABE MAN",
        new OperationPeriod(new Collection(2022, Season.S))),
    ...
    RKHP: new LineCDG("Rei Kawakubo [COMME des GARÇONS HOMME PLUS under canadian trademark]",
        ...
        ProductionSchedule.EARLY),
    JWCDGD: new LineCDG("JUNYA WATANABE COMME des GARÇONS denim",
    ...
    DR05: new LineCDG("COMME des GARÇONS [Aoyama exclusive holidays special]"),
});
