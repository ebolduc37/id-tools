...
class InputIM extends Input {
    ...
    /**
     * Evaluate if the logo is RD.
     * @return {boolean} True if it is; false otherwise.
     */
    isLogoRD() {
        return this.isLogo(InputIM.LogoStyle.RD);
    }

    /**
     * Evaluate if the logo is BS.
     * @return {boolean} True if it is; false otherwise.
     */
    isLogoBS() {
        return this.isLogo(InputIM.LogoStyle.BS);
    }
     ...
     */
    isLogoStyleValid() {
        return this.isLogoUnspecified() || Object.values(InputIM.LogoStyle).includes(this.logoStyle);
    }
    ...
    confirmLogoStyle() {
        ...
        else if (this.isLogoRD()) message = "rounded ISSEY MIYAKE logo and its variants";
        else if (this.isLogoBS()) message = "rounded ISSEY MIYAKE logo over the brushstroke and its variants";
        else if (this.isLogoIM_BW()) message = "black ISSEY MIYAKE logo on white background";
        else if (this.isLogoIM_WB()) message = "white ISSEY MIYAKE logo on black background";
        else if (this.isLogoME_BW()) message = "black ISSEY MIYAKE MEN logo on white background";
        else if (this.isLogoME_WB()) message = "white ISSEY MIYAKE MEN logo on black background";
